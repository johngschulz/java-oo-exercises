...
public class ComputerMenu{
	...
	public static void main(String[] args)
	{
		...
		{	
			...
			System.out.println("2. Display list of available computers");
		...
		public void processInput(int selection)
		{
			if (selection ==1){
				...
				System.out.println("Please select processor speed for the computer:");
				int proc = s.nextInt();
				while (proc < 1){
					System.out.println("Invalid processor speed, please select a positive value");
					proc = s.nextInt();
				}
				c.setProcessor(proc);
				System.out.println("Here is the computer's status after the change:");
				...
				int mem = s.nextInt();
				while (mem < 1){
					System.out.println("Invalid amount, please select a positive value");
					mem = s.nextInt();
				}
				c.addMemory(mem);
				System.out.println("Here is the computer's status after the change:");
		...
		private Computer selectComputer()
		{
			...
			int selection = s.nextInt();
			while (selection < 0 || selection > computers.size()){
				System.out.println("Invalid selection please try again: ");
				selection = s.nextInt();
				}
		...
		{
			System.out.println("Please enter the computer memory: ");
			int mem = s.nextInt();
			while (mem < 0){
			...
			System.out.println("Please enter the physical computer size: ");
			int size = s.nextInt();
			while (size < 0){
				System.out.println("Invalid value, please enter a positive value: ");
				size = s.nextInt();
			}
			System.out.println("Please enter the computer brand: ");
			String brand = s.next();
